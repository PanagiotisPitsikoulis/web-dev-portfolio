        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Looking for a skilled software engineer with a proven track record? I bring over 7
              years of experience in web design, development, and innovative solutions. Explore my
              portfolio and discover how I can add value to your team.
            </p>
